...
---- integrate into controller and remove write part
LIBRARY ieee;
...
ENTITY RX_RAM IS
	PORT (
		...
		wr_en : IN STD_LOGIC;
		rd_en : IN STD_LOGIC;
		rx_length : IN STD_LOGIC_VECTOR (10 DOWNTO 0);
		wr_addr : OUT STD_LOGIC_VECTOR (10 DOWNTO 0);
		rd_addr : OUT STD_LOGIC_VECTOR (10 DOWNTO 0)
	);
END ENTITY RX_RAM;

ARCHITECTURE arch OF RX_RAM IS
